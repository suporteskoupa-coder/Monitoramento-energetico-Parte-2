...
> **Confirmação pendente:** os documentos foram alinhados ao candidato atual a firmware,
> que usa o GPIO 34. Pedro ainda precisa confirmar se a montagem física foi migrada para esse
> pino, identificar a variante do SCT-013 e medir os componentes. Este material não substitui
> a conferência da bancada.
...
| [`evidencias/fotos/`](evidencias/fotos/) | Fotos da montagem física |
